...
veg_dict = {"Vegetarian,Indian":"Indian","Indian,Vegetarian":"Indian", "Mexican,Vegetarian":"Mexican","Vegetarian,Salads":"Salads", "Salads,Vegetarian":"Salads", "Vegetarian,Thai":"Thai", "Seafood,Vegetarian,Greek,Indian":"Greek and Indian","Middle Eastern,Lebanese,Mediterranean,Vegetarian Friendly,Vegan Options,Gluten Free Options":"Lebanese",
...
veg_df['cuisines'].value_counts().to_csv(r'cuisine_count.csv')
